...
Download the test folder and put it into your asgn3 directory. You can add "test/" to .gitignore and the test folder will not be tracked by git. This script depends on `./` being in your `$PATH` variable (I promise I won't do what Daniel told us about in lecture : )).  
